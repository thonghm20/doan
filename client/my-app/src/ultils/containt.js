...
const {FaShieldAlt,  FiTruck, FaGift, FaReplyAll, FaTty} = icons

export const Productextraininfomation = [
    {
        id:'1',
        name:'Guarantee',
...
const {AiOutlineDashboard, MdGroups, RiProductHuntLine, FaRegMoneyBillAlt} = icons
