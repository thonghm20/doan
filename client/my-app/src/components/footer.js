...
const Footer = () => {
  return (
    <div className='w-full '>
      <div className='h-[103px]  w-full flex bg-main items-center justify-center'>
    <div className='w-main flex items-center justify-between'>
        ...
        <input type='text' placeholder='Email Address' className='p-4 pr-0 rounded-l-full flex-1 bg-[#F04646] outline-none text-gray-100 placeholder:text-sm placeholder:text-gray-200 placeholder:italic placeholder:opacity-50'></input>
        <div className='h-[56px] w-[56px ] bg-[#F04646] rounded-r-full flex items-center justify-center text-white'><IoMdMail size={18}/></div>
        </div>
    </div>
    </div>
